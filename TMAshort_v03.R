##########################################
## Trading system: Triple Moving Average: Short (10,20,50) 
## eric.niedling@gmail.com - Nov. 2016
##########################################

require(plyr)

# sources files with technical indicators are required
thePath = "data\\"
...
if (!file.exists("data\\Trades.dat")) {  
